...
- `GET /api/invoices/stamps?sql=true` and `GET /api/products/fingerprints?project=true` — a global conversion with a query form, and one without (SM0030).
